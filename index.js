...
app.get("/", (req, res) => {
  res.send("<h3> Welcome to honeypotflix! This is the project creating a React app linked to its backend using REST API and MongoDB as its database. Thank you for visiting.</h3>");
});
